 ...
 */
@Path("/")
public interface BaseballCardCollectionServiceA {
    ...
    public BaseballCardA get(@PathParam("id") Integer id);
    ...
    public List<BaseballCardA> get(@PathParam("playerName") String playerName);
    ...
    @POST
    @Path("/BaseballCard")
    public Integer add(@Context HttpHeaders hh, BaseballCardA card);
    ...
    public void update(@PathParam("id") Integer id, BaseballCardA card);
