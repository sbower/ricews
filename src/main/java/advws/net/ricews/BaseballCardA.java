...
/**
 * data bean used by the {@link BaseballCardCollectionServiceA}
 * 
 * @author Kuali Rice Team (rice.collab@kuali.org)
 *
 */
@XmlRootElement
public class BaseballCardA {
    
    private String cardType;
    private String playerName;
    private Integer year;
    
    public BaseballCardA() {
    }

    public BaseballCardA(String playerName, String cardType, Integer year) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        BaseballCardA other = (BaseballCardA) obj;
